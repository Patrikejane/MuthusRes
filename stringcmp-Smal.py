...
#
with open('file3.csv','rb') as f_open:
    data =  [line.split(',')[0:2] for line in f_open]

    data2 = [arr[0]+ ' ' +arr[1] for arr in data]

csvfile="C:/Users/Maneesha/Desktop/MuthusRes/result.txt"
if (__name__ == '__main__'):
  ...
  for i in range(len(strings[0])):
    ...
    for j in range(len(strings[0])):
      ...
      qgram(str1,str2,1)
      time_used2 = time.time() - start_time
      start_time3 = time.time()
      qgram(str1,str2,2)
      time_used3 = time.time() - start_time
      start_time4 = time.time()
      qgram(str1,str2,3)
      time_used4 = time.time() - start_time
      start_time5 = time.time()
      posqgram(str1,str2,1)
      time_used5 = time.time() - start_time
      start_time6 = time.time()
      posqgram(str1,str2,2)
      time_used6 = time.time() - start_time
      start_time7 = time.time()
      posqgram(str1,str2,3)
      time_used7 = time.time() - start_time
      start_time8 = time.time()
      sgram(str1,str2,[[0],[0,1],[1,2]])
      time_used8 = time.time() - start_time
      start_time9 = time.time()
      editdist(str1,str2)
      time_used9 = time.time() - start_time
      start_time10 = time.time()
      mod_editdist(str1,str2)
      time_used10 = time.time() - start_time
      start_time11 = time.time()
      bagdist(str1,str2)
      time_used11 = time.time() - start_time
      start_time12 = time.time()
      editex(str1,str2)
      time_used12 = time.time() - start_time
      start_time13 = time.time()
      seqmatch(str1,str2)
      time_used13 = time.time() - start_time
      start_time14 = time.time()
      compression(str1,str2,'bz2')
      time_used14 = time.time() - start_time
      start_time15 = time.time()
      compression(str1,str2,'zlib')
      time_used15 = time.time() - start_time
      start_time16 = time.time()
      compression(str1,str2,'arith')
      time_used16 = time.time() - start_time
      start_time17 = time.time()
      lcs(str1,str2,2)
      time_used17 = time.time() - start_time
      start_time18 = time.time()
      lcs(str1,str2,3)
      time_used18 = time.time() - start_time
      start_time19 = time.time()
      ontolcs(str1,str2,2)
      time_used19 = time.time() - start_time
      start_time20 = time.time()
      ontolcs(str1,str2,3)
      time_used20 = time.time() - start_time
      start_time21 = time.time()
      permwinkler(str1,str2)
      time_used21 = time.time() - start_time
      start_time22 = time.time()
      sortwinkler(str1,str2)
      time_used22 = time.time() - start_time
      start_time23 = time.time()
      swdist(str1,str2)
      time_used23 = time.time() - start_time
      start_time24 = time.time()
      syllaligndist(str1,str2)
      time_used24 = time.time() - start_time
      start_time25 = time.time()
      charhistogram(str1,str2)
      time_used25 = time.time() - start_time
      start_time26 = time.time()
      twoleveljaro(str1,str2)
      time_used26 = time.time() - start_time
      start_time27 = time.time()
      twoleveljaro(str1,str2, qgram, 0.8)
      time_used27 = time.time() - start_time
